...
import acyclic.file
import com.rallyhealth.ujson.v1.json4s.Json4sJson
import com.rallyhealth.upickle.v1.TestUtil
import utest._
...
object JvmExampleTests extends TestSuite {
  ...
  val tests = Tests {
    ...
    test("other"){
      test("argonaut"){
        import com.rallyhealth.ujson.v1.argonaut.ArgonautJson
        ...
        val items: Seq[String] = ArgonautJson.transform(
          updatedArgJson,
          com.rallyhealth.upickle.v1.default.reader[Seq[String]]
        )

        items ==> Seq("HELLO", "WORLD")

        val rewritten = com.rallyhealth.upickle.v1.default.transform(items).to(ArgonautJson)
      ...
      test("circe"){
        import com.rallyhealth.ujson.v1.circe.CirceJson
        ...
        val rewritten = com.rallyhealth.upickle.v1.default.transform(items).to(CirceJson)
      ...
      test("json4s"){
        ...
        val rewritten = com.rallyhealth.upickle.v1.default.transform(items).to(Json4sJson)
      ...
      test("playJson"){
        import com.rallyhealth.ujson.v1.play.PlayJson
        ...
        val rewritten = com.rallyhealth.upickle.v1.default.transform(items).to(PlayJson)
