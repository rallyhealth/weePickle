...
import acyclic.file
import utest._
import com.rallyhealth.upickle.v1.TestUtil._
import com.rallyhealth.upickle.v1.default.{read, write}
...
object Custom {
  ...
  abstract class ThingBaseCompanion[T <: ThingBase](f: (Int, String) => T){
    implicit val thing2Writer = com.rallyhealth.upickle.v1.default.readwriter[String].bimap[T](
      t => t.i + " " + t.s,
      str => {
...
//  implicitly[com.rallyhealth.upickle.v1.old.Writer[com.rallyhealth.upickle.v1.MixedIn.Obj.ClsB]]
//  println(write(ADTs.ADTc(1, "lol", (1.1, 1.2))))
//  implicitly[com.rallyhealth.upickle.v1.old.Writer[ADTs.ADTc]]
...
//      test - com.rallyhealth.upickle.v1.write(Wrapper(Child))
//    }
//
...
//    */
    test("exponential"){
      ...
      val ww1 = implicitly[com.rallyhealth.upickle.v1.default.Writer[Exponential.A1]]
    }
    ...
    test("commonCustomStructures"){
      ...
      test("sealedHierarchy"){
        ...
        import Hierarchy._
        test("shallow"){
          test - rw(B(1), """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.B", "i":1}""")
          test - rw(C("a", "b"), """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.C", "s1":"a","s2":"b"}""")
          test - rw(AnZ: Z, """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.AnZ"}""")
          test - rw(AnZ, """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.AnZ"}""")
          test - rw(Hierarchy.B(1): Hierarchy.A, """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.B", "i":1}""")
          test - rw(C("a", "b"): A, """{"$type": "com.rallyhealth.upickle.v1.Hierarchy.C", "s1":"a","s2":"b"}""")
        ...
        test("tagLast"){
          ...
          test - rw(C("a", "b"), """{"s1":"a","s2":"b", "$type": "com.rallyhealth.upickle.v1.Hierarchy.C"}""")
          test - rw(B(1), """{"i":1, "$type": "com.rallyhealth.upickle.v1.Hierarchy.B"}""")
          test - rw(C("a", "b"): A, """{"s1":"a","s2":"b", "$type": "com.rallyhealth.upickle.v1.Hierarchy.C"}""")
        }
        test("deep"){
          import DeepHierarchy._

          test - rw(B(1), """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.B", "i":1}""")
          test - rw(B(1): A, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.B", "i":1}""")
          test - rw(AnQ(1): Q, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.AnQ", "i":1}""")
          test - rw(AnQ(1), """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.AnQ","i":1}""")

          test - rw(F(AnQ(1)), """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.F","q":{"$type":"com.rallyhealth.upickle.v1.DeepHierarchy.AnQ", "i":1}}""")
          test - rw(F(AnQ(2)): A, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.F","q":{"$type":"com.rallyhealth.upickle.v1.DeepHierarchy.AnQ", "i":2}}""")
          test - rw(F(AnQ(3)): C, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.F","q":{"$type":"com.rallyhealth.upickle.v1.DeepHierarchy.AnQ", "i":3}}""")
          test - rw(D("1"), """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.D", "s":"1"}""")
          test - rw(D("1"): C, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.D", "s":"1"}""")
          test - rw(D("1"): A, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.D", "s":"1"}""")
          test - rw(E(true), """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.E", "b":true}""")
          test - rw(E(true): C, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.E","b":true}""")
          test - rw(E(true): A, """{"$type": "com.rallyhealth.upickle.v1.DeepHierarchy.E", "b":true}""")
        }
      }
      test("singleton"){
        import Singletons._

        rw(BB, """{"$type":"com.rallyhealth.upickle.v1.Singletons.BB"}""")
        rw(CC, """{"$type":"com.rallyhealth.upickle.v1.Singletons.CC"}""")
        rw(BB: AA, """{"$type":"com.rallyhealth.upickle.v1.Singletons.BB"}""")
        rw(CC: AA, """{"$type":"com.rallyhealth.upickle.v1.Singletons.CC"}""")
      }
    }
