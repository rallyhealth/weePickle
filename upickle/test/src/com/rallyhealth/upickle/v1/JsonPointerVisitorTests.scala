...
import com.rallyhealth.upickle.v1.core.JsonPointerVisitor.JsonPointerException
import com.rallyhealth.upickle.v1.core.{JsonPointerVisitor, NoOpVisitor}
import utest._
...
object JsonPointerVisitorTests extends TestSuite {
  ...
  implicit lazy val rw = upickle.v1.default.macroRW[Foo]
