...
//      compileError("""read[Array[Object]]("")""").msg
    ...
    test("expWholeNumbers"){
      com.rallyhealth.upickle.v1.default.read[Byte]("0e0") ==> 0.toByte
      com.rallyhealth.upickle.v1.default.read[Short]("0e0") ==> 0
      com.rallyhealth.upickle.v1.default.read[Char]("0e0") ==> 0.toChar
      com.rallyhealth.upickle.v1.default.read[Int]("0e0") ==> 0
      com.rallyhealth.upickle.v1.default.read[Long]("0e0") ==> 0

      com.rallyhealth.upickle.v1.default.read[Byte]("10e1") ==> 100
      com.rallyhealth.upickle.v1.default.read[Short]("10e1") ==> 100
      com.rallyhealth.upickle.v1.default.read[Char]("10e1") ==> 100
      com.rallyhealth.upickle.v1.default.read[Int]("10e1") ==> 100
      com.rallyhealth.upickle.v1.default.read[Long]("10e1") ==> 100

      com.rallyhealth.upickle.v1.default.read[Byte]("10.1e1") ==> 101
      com.rallyhealth.upickle.v1.default.read[Short]("10.1e1") ==> 101
      com.rallyhealth.upickle.v1.default.read[Char]("10.1e1") ==> 101
      com.rallyhealth.upickle.v1.default.read[Int]("10.1e1") ==> 101
      com.rallyhealth.upickle.v1.default.read[Long]("10.1e1") ==> 101

      // Not supporting these for now, since AFAIK none of the
      // JSON serializers I know generate numbers of this form
      //      com.rallyhealth.upickle.v1.default.read[Byte]("10e-1") ==> 1
      //      com.rallyhealth.upickle.v1.default.read[Short]("10e-1") ==> 1
      //      com.rallyhealth.upickle.v1.default.read[Char]("10e-1") ==> 1
      //      com.rallyhealth.upickle.v1.default.read[Int]("10e-1") ==> 1
      //      com.rallyhealth.upickle.v1.default.read[Long]("10e-1") ==> 1
    }
    test("tooManyFields"){
      val b63 = Big63(
        0, 1, 2, 3, 4, 5, 6, 7,
      ...
      implicit val b63rw: com.rallyhealth.upickle.v1.default.ReadWriter[Big63] = com.rallyhealth.upickle.v1.default.macroRW
      implicit val b64rw: com.rallyhealth.upickle.v1.default.ReadWriter[Big64] = com.rallyhealth.upickle.v1.default.macroRW
      val written63 = com.rallyhealth.upickle.v1.default.write(b63)
      assert(com.rallyhealth.upickle.v1.default.read[Big63](written63) == b63)
      val written64 = com.rallyhealth.upickle.v1.default.write(b64)
      assert(com.rallyhealth.upickle.v1.default.read[Big64](written64) == b64)
      val err = compileError("{implicit val b64rw: com.rallyhealth.upickle.v1.default.ReadWriter[Big65] = com.rallyhealth.upickle.v1.default.macroRW}")
