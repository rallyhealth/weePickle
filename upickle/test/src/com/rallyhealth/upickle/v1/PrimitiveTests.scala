...
object PrimitiveTests extends TestSuite {
  ...
  def tests = Tests {
    ...
    test("String"){
      ...
      test("unicode"){
        rw("叉烧包")
        com.rallyhealth.upickle.v1.default.write("叉烧包") ==> "\"叉烧包\""
        com.rallyhealth.upickle.v1.default.write("叉烧包", escapeUnicode = true) ==> "\"\\u53c9\\u70e7\\u5305\""
        com.rallyhealth.upickle.v1.default.read[String]("\"\\u53c9\\u70e7\\u5305\"") ==> "叉烧包"
        com.rallyhealth.upickle.v1.default.read[String]("\"叉烧包\"") ==> "叉烧包"
      }
    ...
    test("Symbol"){
      test("plain") - rw('i_am_a_cow, """ "i_am_a_cow" """)(com.rallyhealth.upickle.v1.default.SymbolReader, com.rallyhealth.upickle.v1.default.SymbolWriter)
