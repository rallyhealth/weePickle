 ...
 * roughly the  whole range of interesting shapes of types supported by com.rallyhealth.upickle.v1.
 */
...
object Hierarchy {
  sealed trait A
  object A{
    implicit def rw: com.rallyhealth.upickle.v1.default.ReadWriter[A] = RW.merge(B.rw, C.rw)
  }
  case class B(i: Int) extends A
  object B{
    implicit def rw: com.rallyhealth.upickle.v1.default.ReadWriter[B] = default.macroRW
  }
  case class C(s1: String, s2: String) extends A
  object C{
    implicit def rw: com.rallyhealth.upickle.v1.default.ReadWriter[C] = default.macroRW
  }

  object Z{
    implicit def rw: com.rallyhealth.upickle.v1.default.ReadWriter[Z] = RW.merge(
      implicitly[com.rallyhealth.upickle.v1.default.ReadWriter[AnZ.type]]
    )
  }
