...
import com.rallyhealth.upickle.v1.core._
import scala.reflect.ClassTag
import com.rallyhealth.ujson.v1.IndexedValue
/**
 * An instance of the com.rallyhealth.upickle.v1 API. There's a default instance at
 * `com.rallyhealth.upickle.v1.default`, but you can also implement it yourself to customize
 * its behavior. Override the `annotate` methods to control how a sealed
 * trait instance is tagged during reading and writing.
 */
trait Api
    extends com.rallyhealth.upickle.v1.core.Types
  ...
  def write[T: Writer](t: T,
    ...
    transform(t).to(com.rallyhealth.ujson.v1.StringRenderer(indent, escapeUnicode)).toString
  }
  /**
  ...
  /**
    ...
    */
  def writeJs[T: Writer](t: T): com.rallyhealth.ujson.v1.Value = transform(t).to[com.rallyhealth.ujson.v1.Value]
  ...
  def writeTo[T: Writer](t: T,
    ...
    transform(t).to(new com.rallyhealth.ujson.v1.Renderer(out, indent = indent, escapeUnicode))
  }
  /**
...
/**
 * The default way of accessing com.rallyhealth.upickle.v1
 */
  ...
  override def taggedObjectContext[T](taggedReader: TaggedReader[T], index: Int) = {
    new ObjVisitor[Any, T]{
      ...
      def subVisitor: Visitor[_, _] =
        if (context == null) com.rallyhealth.upickle.v1.core.StringVisitor
        else context.subVisitor

      def visitKey(index: Int) = {
        if (context != null) context.visitKey(index)
        else com.rallyhealth.upickle.v1.core.StringVisitor
      }
