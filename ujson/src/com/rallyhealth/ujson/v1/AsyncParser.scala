 ...
 *       allowed.
 */
final class AsyncParser[J] protected[v1](
                                            protected[v1] var state: Int,
                                            protected[v1] var curr: Int,
                                            protected[v1] var stack: List[ObjArrVisitor[_, J]],
                                            protected[v1] var path: List[Any],
                                            protected[v1] var data: Array[Byte],
                                            protected[v1] var len: Int,
                                            protected[v1] var allocated: Int,
                                            protected[v1] var offset: Int,
                                            protected[v1] var done: Boolean,
                                            protected[v1] var streamMode: Int
  ...
  protected[v1] def churn(facade: Visitor[_, J]): Either[ParsingFailedException, Seq[J]] = {
 ...
 */
private[v1] class AsyncException extends Exception with control.NoStackTrace

/**
 * This is a more prosaic exception which indicates that we've hit a
 * parsing error.
 */
private[v1] class FailureException extends Exception
