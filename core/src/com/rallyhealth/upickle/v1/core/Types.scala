...
* other internal files can use it, while also mixing it into the `com.rallyhealth.upickle.v1`
...
trait Types{ types =>
  ...
  /**
    ...
    */
  trait SimpleReader[T] extends Reader[T] with com.rallyhealth.upickle.v1.core.SimpleVisitor[Any, T]
  ...
  /**
    ...
    */
  trait Reader[T] extends com.rallyhealth.upickle.v1.core.Visitor[Any, T]{
