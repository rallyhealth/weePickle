...
object shared {
  object that {
    ...
    object That{
      implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[That] = com.rallyhealth.weepickle.v1.default.macroRW
    }
  }
  object other {
    import common.Message
    ...
    object Other{
      implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Other] = com.rallyhealth.weepickle.v1.default.macroRW
    }
  }
  object common {
    case class Message(content: String)
    object Message{
      implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Message] = com.rallyhealth.weepickle.v1.default.macroRW
    }
  }
}
...
object All {
  ...
  sealed trait Outers
  object Outers{
    implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Outers] = com.rallyhealth.weepickle.v1.default.ReadWriter.merge(
      Out1.rw
    )
  }
  case class Out1(a: Other) extends Outers
  object Out1{
    implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Out1] = com.rallyhealth.weepickle.v1.default.macroRW
  }
  ...
  object Inners{
    implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Inners] = com.rallyhealth.weepickle.v1.default.ReadWriter.merge(
      Inner1.rw,
      Inner2.rw
    )
  }
  ...
  object Inner1{
    implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Inner1] = com.rallyhealth.weepickle.v1.default.macroRW
  }
  case class Inner2(a: Message) extends Inners
  object Inner2{
    implicit def rw: com.rallyhealth.weepickle.v1.default.ReadWriter[Inner2] = com.rallyhealth.weepickle.v1.default.macroRW
  }
}

import com.rallyhealth.weepickle.v1.default.{ReadWriter, macroRW}
sealed trait Gadt[T]
object Gadt{
...
object AdvancedTests extends TestSuite {
  ...
  val tests = Tests {
    "complexTraits" - {
      val reader = implicitly[com.rallyhealth.weepickle.v1.default.Reader[Outers]]
      val writer = implicitly[com.rallyhealth.weepickle.v1.default.Writer[Outers]]
      assert(reader != null)
      assert(writer != null)
    }
    ...
    test("issues"){
      ...
      //        assert(implicitly[com.rallyhealth.weepickle.v1.default.Reader[TypedFoo]] eq TypedFoo.readWriter)
      //        assert(implicitly[com.rallyhealth.weepickle.v1.default.Writer[TypedFoo]] eq TypedFoo.readWriter)
      //        assert(implicitly[com.rallyhealth.weepickle.v1.default.ReadWriter[TypedFoo]] eq TypedFoo.readWriter)
      //      }
