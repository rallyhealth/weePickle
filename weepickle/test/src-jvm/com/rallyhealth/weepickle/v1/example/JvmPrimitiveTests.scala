  ...
  def tests = Tests {
    test("Date/Time") {
      ...
      test("Instant") {
        ...
        test("Millis") {
          WeePickle.InstantReader.visitInt64(1579664660824L, -1) ==> Instant.parse("2020-01-22T03:44:20.824Z")
          WeePickle.InstantReader.visitFloat64String("1579664660824", -1) ==> Instant.parse("2020-01-22T03:44:20.824Z")
          WeePickle.InstantReader.visitFloat64StringParts("1579664660824", -1, -1, -1) ==> Instant.parse("2020-01-22T03:44:20.824Z")
        }
      }
      test("Date") {
