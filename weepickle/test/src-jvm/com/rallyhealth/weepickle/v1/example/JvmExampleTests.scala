    ...
    test("other"){
      test("argonaut"){
        ...
        val items: Seq[String] = ArgonautJson.transform(
          updatedArgJson,
          com.rallyhealth.weepickle.v1.default.reader[Seq[String]]
        )

        items ==> Seq("HELLO", "WORLD")

        val rewritten = com.rallyhealth.weepickle.v1.default.transform(items).to(ArgonautJson)
      ...
      test("circe"){
        ...
        val rewritten = com.rallyhealth.weepickle.v1.default.transform(items).to(CirceJson)
      ...
      test("json4s"){
        ...
        val rewritten = com.rallyhealth.weepickle.v1.default.transform(items).to(Json4sJson)
      ...
      test("playJson"){
        ...
        val rewritten = com.rallyhealth.weepickle.v1.default.transform(items).to(PlayJson)
