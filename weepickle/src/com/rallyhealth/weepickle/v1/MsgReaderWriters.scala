...
trait MsgTransceivers extends com.rallyhealth.weepickle.v1.core.Types with MacroImplicits {
  implicit val MsgValueR: Receiver[com.rallyhealth.weepack.v1.Msg] =
    new Receiver.Delegate(com.rallyhealth.weepack.v1.Msg)

  implicit val MsgValueW: Transmitter[com.rallyhealth.weepack.v1.Msg] =
    new Transmitter[com.rallyhealth.weepack.v1.Msg] {
