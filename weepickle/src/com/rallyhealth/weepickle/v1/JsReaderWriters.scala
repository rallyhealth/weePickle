...
trait JsTransceivers extends com.rallyhealth.weepickle.v1.core.Types with MacroImplicits {
  ...
  implicit val JsValueR: Receiver[com.rallyhealth.weejson.v1.Value] =
    new Receiver.Delegate(com.rallyhealth.weejson.v1.Value)
  ...
  implicit def JsTrueR: Receiver[com.rallyhealth.weejson.v1.True.type] =
    JsValueR.narrow[com.rallyhealth.weejson.v1.True.type]
  implicit def JsFalseR: Receiver[com.rallyhealth.weejson.v1.False.type] =
    JsValueR.narrow[com.rallyhealth.weejson.v1.False.type]
  implicit def JsNullR: Receiver[com.rallyhealth.weejson.v1.Null.type] =
    JsValueR.narrow[com.rallyhealth.weejson.v1.Null.type]
  ...
  implicit def JsTrueW: Transmitter[com.rallyhealth.weejson.v1.True.type] =
    JsValueW.narrow[com.rallyhealth.weejson.v1.True.type]
  implicit def JsFalseW: Transmitter[com.rallyhealth.weejson.v1.False.type] =
    JsValueW.narrow[com.rallyhealth.weejson.v1.False.type]
  implicit def JsNullW: Transmitter[com.rallyhealth.weejson.v1.Null.type] =
    JsValueW.narrow[com.rallyhealth.weejson.v1.Null.type]
  implicit val JsValueW: Transmitter[com.rallyhealth.weejson.v1.Value] =
    new Transmitter[com.rallyhealth.weejson.v1.Value] {
