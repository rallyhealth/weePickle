...
2. All packages are prefixed with `com.rallyhealth.v1`, which prevents classpath conflicts.
...
- Same macro limiations as [uPickle](http://www.lihaoyi.com/upickle/#Limitations)
