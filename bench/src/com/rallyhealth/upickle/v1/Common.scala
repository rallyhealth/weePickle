...
object Common{
  ...
  def upickleLegacy(duration: Int) = {
    ...
    bench[String](duration)(
      com.rallyhealth.upickle.v1.legacy.read[Data](_),
      com.rallyhealth.upickle.v1.legacy.write(_)
    )
  ...
  def upickleDefault(duration: Int) = {
    ...
    bench[String](duration)(
      com.rallyhealth.upickle.v1.default.read[Data](_),
      com.rallyhealth.upickle.v1.default.write(_)
    )
  }
  ...
  def upickleBinaryLegacy(duration: Int) = {
    ...
    bench[Array[Byte]](duration)(
      com.rallyhealth.upickle.v1.legacy.readBinary[Data](_),
      com.rallyhealth.upickle.v1.legacy.writeBinary(_)
    )
...
//  }
  ...
  def upickleDefaultCached(duration: Int) = {
    implicit lazy val rw1: com.rallyhealth.upickle.v1.default.ReadWriter[Data] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw2: com.rallyhealth.upickle.v1.default.ReadWriter[A] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw3: com.rallyhealth.upickle.v1.default.ReadWriter[B] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw4: com.rallyhealth.upickle.v1.default.ReadWriter[C] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw5: com.rallyhealth.upickle.v1.default.ReadWriter[LL] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw6: com.rallyhealth.upickle.v1.default.ReadWriter[Node] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw7: com.rallyhealth.upickle.v1.default.ReadWriter[End.type] = com.rallyhealth.upickle.v1.default.macroRW
    implicit lazy val rw8: com.rallyhealth.upickle.v1.default.ReadWriter[ADTc] = com.rallyhealth.upickle.v1.default.macroRW
