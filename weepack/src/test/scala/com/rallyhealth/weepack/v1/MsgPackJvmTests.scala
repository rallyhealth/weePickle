...
object MsgPackJvmTests extends TestSuite {
  ...
  val tests = Tests {
    test("hello") {
      ...
      val casesJson = "weepack/src/test/resources/cases.json"
      val casesMsg = "weepack/src/test/resources/cases.msg"
      val casesCompactMsg = "weepack/src/test/resources/cases_compact.msg"
